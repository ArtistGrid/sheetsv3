...
async function run(env: Env): Promise<void> {
  ...
  await env.BUCKET.put("artists.csv", artistsCSV, { httpMetadata: { contentType: "text/csv" } });

  console.log(`Done: ${hub.length} hub + ${exclusives.length} exclusives = ${artists.length} artists`);
}
